...
| Log-normalisation              | Easy to run, incorporated in many intermediate processing pipeline, used for analyses that require "minimal" normalisation | Does not account for spatial patterns                                                    |
...
**You don't always want to normalise**
...
- Don't: Some analyses that 

Unnormalised, or **minimally normalised** counts:
