...
The tabula sapiens project ([paper](https://www.science.org/doi/10.1126/science.abl4896)) as built a single cell atalas from a good number of human tissues. Its data is browseable and hosted in the [cellXgene tabular sapiens collection](https://cellxgene.cziscience.com/collections/e5f58829-1a66-40b5-a624-9046778e74f5)
...
Broad cell class looks pretty good. There's colon included. Some individual level effect in the UMAP (stem cells limited to 1-2 samples). It'll work, and theres an easy link to download the data.
...
TODO: LOAD PRECALLED from cell_typeing.R


UPDATE FOR BETTER CALLING.
