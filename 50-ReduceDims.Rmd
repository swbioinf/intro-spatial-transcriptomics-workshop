...
```{r echo=FALSE, results='hide', warnings=FALSE, eval=FALSE}
# This is here for testing, shoudl be off in final build
...
so <- readRDS("data/GSE234713_CosMx_IBD_seurat_02_rna70_neg4.RDS" )
