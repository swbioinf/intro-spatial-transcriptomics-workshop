...
To get started, lets launch a fresh R session, and load the libraries and data we need.
...
# Reload the filtered Seurat object from yesterday
so    <- here("data", "GSE234713_CosMx_IBD_seurat_02_rna70_neg4.RDS")
```
